...
def arming():
	...
	try:
		arming_cl = rospy.ServiceProxy("/uav2/mavros/cmd/arming", CommandBool)
...
def takeoff():
	mode = rospy.ServiceProxy("/uav2/mavros/set_mode", SetMode)
...
if __name__=="__main__":
	...
	pub = rospy.Publisher("/uav2/mavros/setpoint_velocity/cmd_vel_unstamped",Twist,queue_size=100)
	pub1 = rospy.Publisher("/uav2/mavros/setpoint_raw/local",PositionTarget,queue_size=100)
	...
	uav_pos=rospy.Subscriber("/uav2/mavros/global_position/local",Odometry,handle_poses)
	...
	rospy.Subscriber("chatter2", Twist, callback)
	rospy.Subscriber("setpoint_pos2", PoseStamped, pos_callback)

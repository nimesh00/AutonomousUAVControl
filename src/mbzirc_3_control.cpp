...
int main(int argc, char **argv)
{
    ...
    ros::Publisher local_bodyFrame_pos_pub = nh.advertise<mavros_msgs::PositionTarget>
            ("uav3/mavros/setpoint_raw/local", 1);
